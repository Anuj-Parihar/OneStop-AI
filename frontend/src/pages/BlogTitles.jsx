...
import { Hash, Sparkles, Clipboard } from 'lucide-react';
  ...
  return (
     <div className="p-6 h-full overflow-y-scroll gap-4 flex items-start flex-wrap text-slate-700">
      ...
      >
        ...
        <br />
        <button disabled={loading} className="mt-6 w-full  text-white px-4 py-2 rounded-lg bg-gradient-to-r from-[#C341F6] to-[#8E37E8] flex items-center justify-center gap-2 text-sm cursor-pointer">
          {
        ...
        <div className="flex items-center justify-between">
          ...
          {content && (
            <Clipboard
              ...
              className="w-5 h-5 text-gray-500 cursor-pointer hover:text-purple-600"
            />
          )}
        </div>
