...
import { Eraser, Sparkles, Expand } from 'lucide-react';
  ...
  return (
    <div className="p-6 h-full overflow-y-scroll gap-4 flex items-start flex-wrap text-slate-700">
      ...
      >
        ...
        <button disabled={loading} className="mt-6 w-full  text-white px-4 py-2 rounded-lg bg-gradient-to-r from-[#F6AB41] to-[#FF4938] flex items-center justify-center gap-2 text-sm cursor-pointer">
        ...
        {!content ? (
          ...
          <div className="flex flex-col gap-3">
            ...
            <button
              ...
              className="mt-2 flex items-center justify-center gap-2 px-4 py-2 rounded-lg bg-gradient-to-r from-[#F6AB41] to-[#FF4938] text-white text-sm"
            >
